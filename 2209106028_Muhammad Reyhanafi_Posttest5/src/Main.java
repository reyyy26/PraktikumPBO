...
public class Main {
    ...
    private static void inputPetani(int jumlahData) throws IOException {
        clear();
        System.out.println("===========================");
        ...
        for (int i = 1; i <= batasan; i++) {
            ...
            System.out.print("Masukkan Alamat Petani: ");
            String alamatPetani = input.readLine();
            System.out.println("===========================");

            Petani petani = new Petani(idPetani, namaPetani, alamatPetani);
    ...
    private static void inputPupuk(int jumlahData) throws IOException {
        clear();
        System.out.println("========================");
        System.out.print("Masukkan ID Petani: ");
        ...
        for (int i = 1; i <= batasan; i++) {
            System.out.print("Masukkan Jenis Pupuk (1. Organik / 2. Anorganik): ");
            int jenisPupukChoice = Integer.parseInt(input.readLine());
            String jenisPupuk;
            switch (jenisPupukChoice) {
                case 1:
                    jenisPupuk = "Organik";
                    break;
                case 2:
                    jenisPupuk = "Anorganik";
                    break;
                default:
                    System.out.println("Pilihan jenis pupuk tidak valid. Masukkan jenis pupuk yang benar.");
                    continue;
            }
            System.out.print("Masukkan Nama Pupuk: ");
            String namaPupuk = input.readLine();
            System.out.print("Masukkan Harga Pupuk: ");
            double hargaPupuk = Double.parseDouble(input.readLine());

            if (jenisPupuk.equals("Organik")) {
                System.out.print("Masukkan Kandungan Organik: ");
                String kandungan = input.readLine();
                PupukOrganik pupuk = new PupukOrganik(idPetani, "Organik", namaPupuk, hargaPupuk, kandungan);
                pupukList.add(pupuk);
            } else if (jenisPupuk.equals("Anorganik")) {
                System.out.print("Masukkan Komposisi Anorganik: ");
                String komposisi = input.readLine();
                PupukAnorganik pupuk = new PupukAnorganik(idPetani, "Anorganik", namaPupuk, hargaPupuk, komposisi);
                pupukList.add(pupuk);
            }
            System.out.println("===========================");
    ...
    public static void displayData() {
        ...
        if (petaniList.isEmpty()) {
            ...
            for (Petani petani : petaniList) {
                ...
                System.out.println("Alamat Petani: " + petani.getAlamat());
                System.out.println("===========================");
                ...
                for (Pupuk pupuk : pupukList) {
                    if (pupuk.getIdPetani().equals(petani.getId())) {
                        ...
                        if (pupuk instanceof PupukOrganik) {
                            System.out.println("Kandungan: " + ((PupukOrganik) pupuk).getKandungan());
                        } else if (pupuk instanceof PupukAnorganik) {
                            System.out.println("Komposisi: " + ((PupukAnorganik) pupuk).getKomposisi());
                        }
    ...
    private static void updateDataPetani() throws IOException {
        ...
        if (petaniToUpdate != null) {
            ...
            System.out.print("Masukkan Alamat Petani baru: ");
            String newAlamatPetani = input.readLine();

            // Perbarui nama dan alamat petani menggunakan setter
            petaniToUpdate.setNama(newNamaPetani);
            petaniToUpdate.setAlamat(newAlamatPetani);
    ...
    private static void updateDataPupuk() throws IOException {
        ...
        for (int i = 0; i < pupukList.size(); i++) {
            if (pupukList.get(i).getIdPetani().equals(idPetani)
                    && pupukList.get(i).getJenisPupuk().equals(jenisPupukToUpdate)) {
